...
def getWeather():
    ...
    #weather
    api = "https://api.openweathermap.org/data/3.0/onecall?lat=" + str(location.latitude) + "&lon=" + str(location.longitude) + "&units=metric&exclude=hourly&appid=3a87c6dec841e621f5b834689d4324bf"
    ...
    photo1 = ImageTk.PhotoImage(file = f"C:/Users/smigu/Weather app/Weather_forecast/icon/{firstdayimage}@2x.png")
    ...
    img = (Image.open(f"C:/Users/smigu/Weather app/Weather_forecast/icon/{seconddayimage}@2x.png"))
    ...
    img = (Image.open(f"C:/Users/smigu/Weather app/Weather_forecast/icon/{thirddayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"C:/Users/smigu/Weather app/Weather_forecast/icon/{fourthdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"C:/Users/smigu/Weather app/Weather_forecast/icon/{fifthdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"C:/Users/smigu/Weather app/Weather_forecast/icon/{sixthdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"C:/Users/smigu/Weather app/Weather_forecast/icon/{seventhdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
...
image = Image.open("C:/Users/smigu/Weather app/Weather_forecast/Images/logo.png")
image_icon = ImageTk.PhotoImage(image)
root.iconphoto(False, image_icon)

Round_box = PhotoImage(file = "C:/Users/smigu/Weather app/Weather_forecast/Images/Rounded Rectangle 1.png")
...
Search_image = PhotoImage(file = "C:/Users/smigu/Weather app/Weather_forecast/Images/Rounded Rectangle 3.png")
myimage = Label(image = Search_image, bg = "#57adff")
myimage.place(x = 270, y = 120)

weat_image = PhotoImage(file = "C:/Users/smigu/Weather app/Weather_forecast/Images/Layer 7.png")
...
search_icon = PhotoImage(file = "C:/Users/smigu/Weather app/Weather_forecast/Images/Layer 6.png")
...
firstbox = PhotoImage(file =  "C:/Users/smigu/Weather app/Weather_forecast/Images/Rounded Rectangle 2.png")
secondbox = PhotoImage(file =  "C:/Users/smigu/Weather app/Weather_forecast/Images/Rounded Rectangle 2 copy.png")
...
"""
image_icon = PhotoImage(file = "C:/Users/smigu/Weather app/Weather_forecast/Images/logo.jfif")
root.iconphoto(False, image_icon)
"""
